...
2. Применение модификаторов в порядке приоритета:
   ...
   - Событийные модификаторы (сезонные, лунные циклы, серверные бафы)
...
1. **Сбор всех модификаторов** в порядке приоритета:
   ...
   - Событийные модификаторы (сезонные бонусы, лунные циклы, серверные бафы)
...
**Обоснование:** Production Service должен учитывать временные события и модификаторы для корректного применения бонусов.
