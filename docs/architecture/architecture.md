...
- Webhook обработка Telegram обновлений
- Команды запуска и управления Mini App
- Deep linking в разделы игры
- Push уведомления о игровых событиях
...
### 4. Планируемые сервисы (будущее разделение)

При росте системы планируется выделение следующих сервисов:

#### Telegram Bot Service
- Telegram Bot API интеграция
- Запуск Mini App через команды бота
- Deep linking и уведомления
...
graph TB
    ...
    subgraph "Облачная инфраструктура"
        ...
        subgraph "Docker Compose Environment"
            BOT[Telegram Bot<br/>Golang Container]
